<section id="hero-stats-section"
    ...
    <div class="absolute inset-0 -z-20 overflow-hidden">
        <div class="absolute w-[700px] h-[700px] bg-gradient-to-tr from-blue-500/30 via-pink-400/20 to-purple-500/30 rounded-full blur-[250px] top-[-100px] left-1/4 animate-pulse-slow"></div>
        <div class="absolute w-[600px] h-[600px] bg-gradient-to-bl from-amber-400/20 via-blue-300/10 to-purple-400/20 rounded-full blur-[220px] bottom-[-100px] right-1/4 animate-pulse-slow"></div>
        <div class="absolute w-[500px] h-[500px] bg-gradient-radial from-white/10 via-blue-400/5 to-transparent rounded-full blur-[300px] top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 animate-spin-slow"></div>
    </div>
    ...
    <div class="container mx-auto mt-28 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="stat-card group relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 text-center shadow-[0_0_25px_rgba(255,255,255,0.05)] hover:shadow-[0_0_60px_rgba(80,140,255,0.25)] transition-all hover:-translate-y-2 duration-500 overflow-hidden">
                <div class="absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br from-blue-400 via-indigo-400 to-cyan-300 blur-2xl transition-all"></div>
            ...
            <div class="stat-card group relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 text-center shadow-[0_0_25px_rgba(255,255,255,0.05)] hover:shadow-[0_0_60px_rgba(140,100,255,0.25)] transition-all hover:-translate-y-2 duration-500 overflow-hidden">
                <div class="absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br from-purple-400 via-indigo-400 to-blue-500 blur-2xl transition-all"></div>
            ...
            <div class="stat-card group relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 text-center shadow-[0_0_25px_rgba(255,255,255,0.05)] hover:shadow-[0_0_60px_rgba(255,160,200,0.25)] transition-all hover:-translate-y-2 duration-500 overflow-hidden">
                <div class="absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br from-amber-400 via-pink-400 to-purple-500 blur-2xl transition-all"></div>
                <div class="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-gradient-to-br from-amber-400 via-pink-400 to-purple-500 text-white shadow-lg group-hover:scale-110 transition-transform duration-500">
            ...
            <div class="stat-card group relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 text-center shadow-[0_0_25px_rgba(255,255,255,0.05)] hover:shadow-[0_0_60px_rgba(255,200,120,0.25)] transition-all hover:-translate-y-2 duration-500 overflow-hidden">
                <div class="absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br from-blue-300 via-amber-400 to-pink-400 blur-2xl transition-all"></div>
                <div class="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-gradient-to-br from-blue-300 via-amber-400 to-pink-400 text-white shadow-lg group-hover:scale-110 transition-transform duration-500">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tl = gsap.timeline({
        scrollTrigger: { trigger: "#hero-stats-section", start: "top 80%" }
    });
    tl.to("#hero-content", { opacity: 1, y: 0, duration: 1, ease: "power3.out" })
      .to("#hero-search", { opacity: 1, y: 0, duration: 0.8, ease: "power3.out" }, "-=0.4")
      .to("#hero-ctas", { opacity: 1, y: 0, duration: 0.8, ease: "power3.out" }, "-=0.4")
      .to("#hero-image", { opacity: 1, scale: 1, duration: 1, ease: "power3.out" }, "-=0.6");

    // Parallax image effect
    gsap.to("#hero-image", {
        yPercent: -10, ease: "none",
        scrollTrigger: { trigger: "#hero-stats-section", start: "top bottom", scrub: true }
    });
    ...
    const particles = [];
    const resizeCanvas = () => { canvas.width = window.innerWidth; canvas.height = document.querySelector("#hero-stats-section").offsetHeight; };
    window.addEventListener("resize", resizeCanvas);
    resizeCanvas();

    class Particle {
        constructor() { this.reset(); }
        reset() { this.x = Math.random()*canvas.width; this.y = Math.random()*canvas.height; this.size=Math.random()*2; this.speedY=0.2+Math.random()*0.4; this.alpha=0.2+Math.random()*0.5; }
        update() { this.y -= this.speedY; if(this.y<-5) this.reset(); }
        draw() { ctx.beginPath(); ctx.fillStyle = `rgba(180,220,255,${this.alpha})`; ctx.arc(this.x,this.y,this.size,0,Math.PI*2); ctx.fill(); }
    }
