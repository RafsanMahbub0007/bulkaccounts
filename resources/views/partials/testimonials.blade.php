<section class="bg-gray-900 py-20">
    <div class="container mx-auto px-6 text-center">
        <!-- Section Title -->
        <h2 class="text-5xl font-serif text-white mb-6 tracking-wide">
            What Our Customers Say
        </h2>
        <!-- Section Subtitle -->
        <p class="text-xl text-gray-300 mb-16 mx-auto max-w-3xl">
        ...
        <div class="flex justify-center gap-16">
            <!-- Left Testimonial -->
            <div class="testimonial-card bg-white/10 backdrop-blur-lg p-8 rounded-xl shadow-lg transition-transform duration-300 ease-in-out hover:scale-105">
                <div class="flex items-center justify-center space-x-6">
                    <img src="https://randomuser.me/api/portraits/men/1.jpg" alt="Customer 1"
                        class="w-20 h-20 rounded-full border-4 border-white shadow-lg hover:shadow-2xl">
                    <div>
                        <h3 class="text-xl font-serif font-semibold text-white">John Doe</h3>
            ...
            <div class="testimonial-card bg-white/10 backdrop-blur-lg p-10 rounded-xl shadow-xl transform scale-105 transition-all duration-500 ease-in-out">
                <div class="flex items-center justify-center space-x-6">
                    <img src="https://randomuser.me/api/portraits/women/2.jpg" alt="Customer 2"
                        class="w-24 h-24 rounded-full border-4 border-white shadow-lg hover:shadow-2xl">
                    <div>
                        <h3 class="text-xl font-serif font-semibold text-white">Jane Smith</h3>
                        <p class="text-sm text-gray-200">Social Media Strategist</p>
                    </div>
                </div>
            ...
            <div class="testimonial-card bg-white/10 backdrop-blur-lg p-8 rounded-xl shadow-lg transition-transform duration-300 ease-in-out hover:scale-105">
                <div class="flex items-center justify-center space-x-6">
                    <img src="https://randomuser.me/api/portraits/men/3.jpg" alt="Customer 3"
                        class="w-20 h-20 rounded-full border-4 border-white shadow-lg hover:shadow-2xl">
                    <div>
                        <h3 class="text-xl font-serif font-semibold text-white">Alex Johnson</h3>
